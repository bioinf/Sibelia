...
namespace SyntenyFinder
{
	...
	VariantCaller::VariantCaller(const std::vector<FASTARecord> & chr, size_t refSeqId, const std::vector<BlockInstance> & blockList, size_t trimK, size_t minBlockSize):
