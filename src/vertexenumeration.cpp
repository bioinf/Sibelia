...
namespace SyntenyFinder
{
	...
	size_t BlockFinder::EnumerateBifurcationsSArrayInRAM(size_t k, std::vector<BifurcationInstance> & positiveBif, std::vector<BifurcationInstance> & negativeBif) const
	{
		positiveBif.clear();
		negativeBif.clear();
		Size bifurcationCount = 0;
